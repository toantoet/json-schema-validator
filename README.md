...
As fge hasn't been around on his fork, we are accepting pull requests here and publishing to net.box.json-schema-validator.  If a point comes when fge returns we will try to get any patchset accepted here merged back into his branch.
